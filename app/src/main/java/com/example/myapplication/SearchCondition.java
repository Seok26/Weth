...
public class SearchCondition extends AppCompatActivity {
    ...
    String kongetsu = defaultDate.substring(4,6);
    String kongitsu = defaultDate.substring(6,8);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton start = (ImageButton)findViewById(R.id.imgConditionStart);
        ...
        ImageButton end = (ImageButton)findViewById(R.id.imgConditionEnd);
    ...
    void showDate()
    {
        DatePickerDialog dialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                EditText edt = (EditText) findViewById(R.id.edtConditionStartDate);
                int y = year;
                int m = month+1;
                int d = dayOfMonth;
                String m1 = "";
                ...
                if(m < 10 && d < 10)
                {
                    m1 = "0" + m;
                    m2 = "0" + d;
                    String msg = String.valueOf(y) + m1 + m2;
                    edt.setText(msg);
                }
                else if(m >= 10 && d < 10)
                {
                    m2 = "0" + d;
                    String msg = String.valueOf(y) + String.valueOf(m) + m2;
                    edt.setText(msg);
                }
                else if(m < 10 && d >= 10)
                {
                    m1  = "0" + m;
                    String msg = String.valueOf(y) + m1 + String.valueOf(d);
                    edt.setText(msg);
                }
                else
                {
                    String msg = String.valueOf(y) + String.valueOf(m) + String.valueOf(d);
                    edt.setText(msg);
                }

            }
        }, Integer.parseInt(kotoshi), Integer.parseInt(kongetsu) - 1, Integer.parseInt(kongitsu));
        dialog.show();
    }
    ...
    void showDate2()
    {
        DatePickerDialog dialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                EditText edt = (EditText) findViewById(R.id.edtConditionEndDate);
                int y = year;
                int m = month+1;
                int d = dayOfMonth;
                String m1 = "";
